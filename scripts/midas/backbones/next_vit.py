...
# function from Next_ViT/classification/utils.py : merge_pre_bn
# copied here to get rid of Next_ViT repo dependancy
...
# end of Next_ViT/classification/nextvit.py
